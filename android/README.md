...
```gradle
dependencies {
    implementation 'com.github.apiverve:stateboundaries-api:1.1.12'
}
```
...
```java
import com.apiverve.stateboundaries.StateBoundariesAPIClient;
import com.apiverve.stateboundaries.APIResponse;
import com.apiverve.stateboundaries.APIException;

// Initialize the client
StateBoundariesAPIClient client = new StateBoundariesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/stateboundaries](https://docs.apiverve.com/ref/stateboundaries)
...
- **Documentation:** [https://docs.apiverve.com/ref/stateboundaries](https://docs.apiverve.com/ref/stateboundaries)
- **Issues:** [GitHub Issues](https://github.com/apiverve/stateboundaries-api/issues)
